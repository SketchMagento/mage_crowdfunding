    ...
    extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $supplierLogo = Mage::helper('marketplace')->getSupplierLogo($customer->getId());

        $fieldset->addField(
            'supplier_profile_logo',
            'file',
            array(
                'label'     => Mage::helper('marketplace')->__('Logo'),
                'name'      => 'supplier_logo',
                'after_element_html' => ($supplierLogo) ? '<br>Uploaded Logo : <img src="'.$supplierLogo.'" alt=""/>' : '',
                'value'     => $customer->getData('supplier_logo'),
                'wysiwyg'   => true,
            )
        );
        $fieldset->addField(
